...
function VPrediction:__init()
	...
	if not _G.VPredictionMenu then
			_G.VPredictionMenu = scriptConfig("[ VP预判修复汉化版 ]by B1nk", "VPrediction")
			_G.VPredictionMenu:addParam("Mode", " │  释放模式  │ ", SCRIPT_PARAM_LIST, 1, {"快", "中", "慢" })
			_G.VPredictionMenu:addSubMenu(" ☆☆━━━━━╮ ", "info")
			...
			_G.VPredictionMenu.Collision:addParam("info", "--> │            请保持默认设置 ", SCRIPT_PARAM_INFO, "")
			...
			_G.VPredictionMenu.Developers:addParam("SC", "--> │碰撞调试 ", SCRIPT_PARAM_ONOFF, false)
			_G.VPredictionMenu:addParam("Version", " │  脚本信息  │ ", SCRIPT_PARAM_INFO, tostring(self.version))
			_G.VPredictionMenu:addParam("about1", " │  脚本汉化  ☆  B1nk ", SCRIPT_PARAM_INFO, "")
			_G.VPredictionMenu:addParam("about2", " ╰━━━━━☆☆ ", SCRIPT_PARAM_INFO, "")
	end
